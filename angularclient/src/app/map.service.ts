...
export class MapService {
  ...
  public getAstarpath(path:string, start:number, end:number, alpha:string): Observable<string> {
    return this.http.get<string>(this.astarURL+path+"&start="+start+"&end="+end+"&alpha="+alpha, this.HTTPOptions);}
